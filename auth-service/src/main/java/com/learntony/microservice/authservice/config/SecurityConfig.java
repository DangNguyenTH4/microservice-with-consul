package com.learntony.microservice.authservice.config;

import com.learntony.microservice.authservice.security.filter.CustomerAuthenticationFilter;
import com.learntony.microservice.authservice.security.filter.CustomerAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/role/save/**").hasAnyAuthority("ROLE_ADMIN");
